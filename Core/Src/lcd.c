...
void LCD_Test(void)
{
	...
	sprintf((char *)&text, "MOBILE ROBOT");
...
uint16_t POINT_COLOR=0xFFFF;	//Cor do pincel
uint16_t BACK_COLOR=BLACK;  //Cor do fundo
//Mostra o caractere na pocisão especificada
//x,y:Coodenadas inciais
...
// Exibe a string
//x,y: coordenada do ponto inicial
